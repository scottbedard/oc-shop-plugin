        ...
        <div>
            ...
            <ul>
                <li
                    ...
                    <i :class="{ 'icon-cube': ! inventory.is_deleted, 'icon-times': inventory.is_deleted }"></i>
                    <div>
                        <div>{{ summarizeInventory(inventory) }}</div>
                        <small>{{ inStockLangString(inventory) }}</small>
                    </div>
                    <a href="#" @click.prevent.stop="onDeleteInventoryClicked(inventory)">
    ...
    export default {
        ...
        methods: {
            ...
            onDeleteInventoryClicked(inventory) {
                ...
                console.log (inventory.is_deleted);
            },
